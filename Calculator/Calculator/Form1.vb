Public Class frmMain
    ...
    Private Sub UnitConvertion_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles UnitConvertion.Click
        UnitConvertion.Checked = True
        Basic.Checked = False
        DateCalculation.Checked = False

        Me.Width = 602
        Me.Size = Me.MaximumSize
        gbUnitConvertion.Visible = True
    ...
    Private Sub Basic_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Basic.Click
        Basic.Checked = True
        UnitConvertion.Checked = False
        DateCalculation.Checked = False
        Me.Size = Me.MinimumSize
        gbDateCalculation.Visible = False
        gbUnitConvertion.Visible = False
            ...
            Else
                Select Case operation
                    ...
                    Case ""
                        Sum = 1 / input
                End Select
                lblHelp.Text = 1 / Val(lblHelp.Text)
                lbl.Text = ""

            End If
        Else
            lbl.Text = 1 / Val(lbl.Text)
    ...
    Private Sub txtFrom_MouseClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles txtFrom.MouseClick

        txtFrom.Text = ""
        txtFrom.Font = lblTo.Font

        txtFrom.ForeColor = Color.Black

    End Sub

    Private Sub txtFrom_Leave(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtFrom.Leave
        txtFrom.Text = "Enter value"
        txtFrom.Font = New Font("Microsoft Sans Serif", 8, FontStyle.Italic)
    ...
    Private Sub btnAddSubstract_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAddSubstract.Click
        Dim d As New Date
        Dim y As New DateInterval With {'Year'= nudear.value}
